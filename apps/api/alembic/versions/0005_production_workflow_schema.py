...
def upgrade() -> None:
    op.add_column("story", sa.Column("active_script_version_id", sa.Integer(), nullable=True))
    op.add_column("story", sa.Column("active_asset_bundle_id", sa.Integer(), nullable=True))
    op.add_column("story", sa.Column("narration_notes", sa.Text(), nullable=True))

    op.add_column("storypart", sa.Column("script_version_id", sa.Integer(), nullable=True))
    op.add_column("storypart", sa.Column("asset_bundle_id", sa.Integer(), nullable=True))
    op.add_column("storypart", sa.Column("source_text", sa.Text(), nullable=False, server_default=""))
    op.add_column("storypart", sa.Column("script_text", sa.Text(), nullable=False, server_default=""))
    op.add_column("storypart", sa.Column("approved", sa.Boolean(), nullable=False, server_default=sa.true()))
    op.add_column("storypart", sa.Column("notes", sa.Text(), nullable=True))

    op.add_column("asset", sa.Column("local_path", sa.Text(), nullable=True))
    op.add_column("asset", sa.Column("source", sa.Text(), nullable=False, server_default="local"))
    op.add_column("asset", sa.Column("duration_ms", sa.Integer(), nullable=True))
    ...
    op.add_column("asset", sa.Column("orientation", sa.Text(), nullable=True))
    op.add_column("asset", sa.Column("file_hash", sa.Text(), nullable=True))
    op.add_column("asset", sa.Column("rating", sa.Integer(), nullable=True))
    op.add_column("asset", sa.Column("attribution", sa.Text(), nullable=True))
    op.add_column("asset", sa.Column("tags", sa.JSON(), nullable=True))

    op.add_column("jobs", sa.Column("story_part_id", sa.Integer(), nullable=True))
    op.add_column("jobs", sa.Column("compilation_id", sa.Integer(), nullable=True))
    op.add_column("jobs", sa.Column("script_version_id", sa.Integer(), nullable=True))
    op.add_column("jobs", sa.Column("asset_bundle_id", sa.Integer(), nullable=True))
    op.add_column("jobs", sa.Column("render_preset_id", sa.Integer(), nullable=True))
    op.add_column("jobs", sa.Column("variant", sa.Text(), nullable=False, server_default="short"))
